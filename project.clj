...
(defproject org.openvoxproject/puppetserver "8.17.0-SNAPSHOT"
  ...
  :managed-dependencies [[org.clojure/clojure "1.12.6"]
                         ...
                         [org.openvoxproject/trapperkeeper-metrics "2.3.3"]
                         [org.openvoxproject/trapperkeeper-metrics "2.3.3" :classifier "test"]
  ...
  :profiles {:defaults {:source-paths  ["dev"]
             ...
             :ezbake {:dependencies ^:replace [;; we need to explicitly pull in our parent project's
                                               ...
                                               [org.openvoxproject/puppetserver "8.17.0-SNAPSHOT"]
                                               [org.openvoxproject/trapperkeeper-webserver]
                                               [org.openvoxproject/trapperkeeper-metrics]]
