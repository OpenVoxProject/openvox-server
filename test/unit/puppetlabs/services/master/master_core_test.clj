...
(deftest jdk-support-status-test
  ...
  (is (= :unsupported (master-service/jdk-support-status "1.8")))
  (is (= :unsupported (master-service/jdk-support-status "1.8.0")))
  (is (= :unsupported (master-service/jdk-support-status "1.9")))
  (is (= :unsupported (master-service/jdk-support-status "1.9.0")))
  (is (= :unsupported (master-service/jdk-support-status "10")))
  (is (= :unsupported (master-service/jdk-support-status "10.0")))
  (is (= :unsupported (master-service/jdk-support-status "11.0")))
  (is (= :unsupported (master-service/jdk-support-status "11.0.7")))
  (is (= :unsupported (master-service/jdk-support-status "17.0")))
  (is (= :unsupported (master-service/jdk-support-status "17.0.4")))
  ...
  (is (= :official (master-service/jdk-support-status "25")))
  (is (= :official (master-service/jdk-support-status "25.0")))
  (is (= :official (master-service/jdk-support-status "25.0.3"))))
